 ...
 * Set database(s).
 */
$mi->config['database'][0]['dsn'] = 'sqlite:' . MIRB_SITE_PATH . '/data/.ht.sqlite';
 ...
 * Template files can reside in the parent or current theme, the CMirb::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly MIRB_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
