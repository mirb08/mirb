<?php
/**
 * Main class for Mirb, holds everything.
 *
 * @package MirbCore
 */
class CMirb implements ISingleton {
	...
	protected function __construct() {
		...
		$mi = &$this;
    require(MIRB_SITE_PATH.'/config.php');
  ...
  /**
	 ...
	 * @return CMirb The instance of this class.
	 */
	public static function Instance() {
		if(self::$instance == null) {
			self::$instance = new CMirb();
		}
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= MIRB_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = MIRB_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $mi = &$this;
    // First the default Mirb themes/functions.php
    include(MIRB_INSTALL_PATH . '/themes/functions.php');
